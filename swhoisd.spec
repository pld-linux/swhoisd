...
%description -l pl
swhoisd to prosty demon whois dostarczaj±cy us³ugê katalogow± whois.
Jest du¿o prostszy do skonfigurowania ni¿ inne dostêpne demony whois,
jak na przyk³ad RIPE whois czy oryginalny SRC whois. Jest tak poniewa¿
swhoisd u¿ywa p³askiego pliku tekstowego zamiast z³o¿onej bazy danych.
Ten serwer whois jest zalecany tylko dla ma³ych baz (najlepiej poni¿ej
200 rekordów, zdecydowanie nie wiêcej ni¿ 1000).

Ten demon jest zgodny z RFC 834 i u¿ywa portu 43 TCP (us³ugi "whois").
